...
- 还不能宣称“发布级 live/native 全 runtime 完成”，因为 Cursor / OpenClaw 仍是 smoke 证据，不是 native/live pass；真实外部写回仍需要 Warden 明确批准。
...
| R-008 跨 runtime 真实投影验证 | 已测通 | Claude / Codex / Cursor / OpenClaw 四端 projection smoke evidence；Cursor / OpenClaw 不宣称 native/live pass |
