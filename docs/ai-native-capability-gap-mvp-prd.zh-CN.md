...
| P-026 | R-008 | Cursor 官方文档 source-backed refresh：由 `meta-scout` 重新抓取官方 CLI overview / using / parameters / installation / output-format 文档，校准 P-024 的 pass / blocked 条件 | 已测通 | meta-scout | 可 | `cursor-live-turn-harness-contract.json` 记录 `officialEvidenceRefreshedAt = 2026-06-04`、`officialEvidenceRefreshOwner = meta-scout`、output-format URL；官方文档证明 `--print`、`--output-format json`、Windows WSL `cursor-agent --version` 验证路径；`tests/setup/eval-meta-agents.test.mjs` 锁定合同 |
...
| Extension backlog | P-025 到 P-060 | meta-conductor | P-026 / P-027 / P-028 / P-029 / P-030 / P-032 / P-033 / P-034 / P-035 / P-036 / P-037 / P-038 / P-039 / P-040 / P-041 / P-042 / P-043 / P-044 / P-045 / P-046 / P-047 / P-048 / P-049 / P-050 / P-051 / P-052 / P-053 / P-054 / P-055 / P-056 / P-057 / P-058 / P-059 / P-060 已测通 | P-025 / P-031 需要外部条件或人工批准；P-024 解阻前不能宣称全 runtime release-grade 完成 |
