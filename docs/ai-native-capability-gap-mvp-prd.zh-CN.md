...
- 本地已有但 `origin/main` 仍未包含：Cursor live harness blocked contract、runtime evidence aggregator / writeback approval、P-015 到 P-021 编排质量轨、P-022 产品面板数据合同、P-012 / P-013 / P-014 / P-023 用户交付轨、P-006 / P-007 全 meta agents shard live evidence、P-024 官方 WSL candidate probe、P-025 到 P-036 并行扩展队列、P-026 / P-027 / P-028 / P-034 / P-036 的本地闭合证据、以及本 PRD v0.22 的状态更新。
...
| P-036 | PRD governance | PRD 状态完整性守卫：测试 PRD 至少保留主干任务、未完成任务、GitHub 差距、并行队列和 AI 课标准，防止后续又散成多份文档 | 已测通 | meta-prism | 可 | `tests/meta-theory/29-capability-gap-complete-product-prd.test.mjs` 与 `tests/meta-theory/35-release-closure-deliverables.test.mjs` 锁定单一 PRD、GitHub 差距、P-025 到 P-036 队列、已测通状态、AI 课五维标准和不能宣称 P-024 完成 |
...
| Extension backlog | P-025、P-026、P-027、P-028、P-029、P-030、P-031、P-032、P-033、P-034、P-035、P-036 | meta-conductor | P-026 / P-027 / P-028 / P-034 / P-036 已测通；剩余可分成 Cursor 解阻、服务化面板、课程样本、writeback 审批、runtime automation、复杂输入扩展 | P-025 / P-031 需要外部条件或人工批准；P-029 / P-030 / P-032 / P-033 / P-035 可继续并行 |
