...
Claude Code. They are generated helpers — not part of this project's source —
and they do not change what this project is.
...
- `.claude/` — agents, skills, hooks, commands, capability index
- `.mcp.json` — MCP server wiring for this project
